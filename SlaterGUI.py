...
# need to do: take a look at high shell density calculation, add documentation about how to use stuff and what it means, look into pypi stuff
...
while run:
    ...
    dty, components = Slater.density(arrayX, atom)
